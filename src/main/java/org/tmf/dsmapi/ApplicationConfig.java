...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.add(org.tmf.dsmapi.customer.CustomerAdminResource.class);
        classes.add(org.tmf.dsmapi.customer.CustomerResource.class);
        classes.add(org.tmf.dsmapi.customerAccount.CustomerAccountAdminResource.class);
        classes.add(org.tmf.dsmapi.customerAccount.CustomerAccountResource.class);
        classes.add(org.tmf.dsmapi.hub.HubResource.class);
        classes.add(org.tmf.dsmapi.paymentMean.PaymentMeanAdminResource.class);
        classes.add(org.tmf.dsmapi.paymentMean.PaymentMeanResource.class);
