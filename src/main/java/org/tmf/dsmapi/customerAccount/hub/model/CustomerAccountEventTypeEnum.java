 ...
 */
package org.tmf.dsmapi.customerAccount.hub.model;
...
public enum CustomerAccountEventTypeEnum {
     ...
     * @return
     */
    public static org.tmf.dsmapi.customerAccount.hub.model.CustomerAccountEventTypeEnum fromString(String text) {
        if (text != null) {
